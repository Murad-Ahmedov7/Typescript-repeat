...
export default function EasyLevel() {
  ...
  return (
    <div>
      <div className="flex items-center j"><p className="text-2xl font-bold">Level:Easy</p></div>

         <p className="text-2xl ">Remember the order of these elements in your mind within 10 seconds.</p>
      ...
      <div><p className="text-xl ">{time}</p></div>
    </div>
  );
}
