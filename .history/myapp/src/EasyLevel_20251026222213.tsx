...
export default function EasyLevel() {
  ...
  const randomColors=[
  {colorName:"Red",bgcolor:"bg-red-500",width:"w-40",height:"h-40"},
  {colorName:"Green",bgcolor:"bg-green-500",width:"w-40",height:"h-40"},
  {colorName:"Blue",bgcolor:"bg-blue-500",width:"w-40",height:"h-40"},
  {colorName:"yellow",bgcolor:"bg-yellow-500",width:"w-40",height:"h-40"}
  ]
