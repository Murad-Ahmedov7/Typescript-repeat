      ...
      <div className="flex items-center justify-center h-[70vh] gap-4 ">
        {randomColors.map((colors) => (
          <button
            ...
            className={`${colors.isSelected?colors.bgcolor:{`${colors.isSelected?colors.bgcolor:colors.bgcolor/50}} ${colors.width} ${colors.height}  hover:scale-125    transition-transform ease-out  `}
