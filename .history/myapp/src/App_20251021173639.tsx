...
function App() {
  ...
  let mesaj:string = "Salam, TypeScript işləyir!";
   console.log(mesaj);
...
// Məqsəd: İstifadəçi ekranda 4 rəngli kvadrat görür və onun ardıcıllığını yadda saxlayıb təkrar etməlidir. Sistem hər dəfə rəngləri dəyişir. Logic və yaddaş üzərində işləyir, CRUD və search yoxdur.
